...
use constant QBITCOIN_CONST => {
    ...
    UPGRADE_MAX_VALUE       => 42_000_000 * 100_000_000, # 43M LTC - stop conversion when upgraded reaches this
    STATIC_REWARD           => 100_000_000, # 1 QLTC/block after upgrade finished
    REWARD_HALVING          => 10_000_000,  # blocks, halving every ~ 3 years and emit 20M QLTC total as block rewards
