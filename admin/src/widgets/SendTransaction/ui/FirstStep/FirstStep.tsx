...
const ECR_DECIMALS = 8;
const SAT_PER_ECR = 10 ** ECR_DECIMALS;
        ...
        >
                ...
                rules={[
                    {
                        ...
                        validator: (_, value: string) => {
                            ...
                            if (!isAddress(trimmed)) {
                                return Promise.reject(new Error('Please input a valid eCurrency address!'));
                            }
            ...
            >
                <InputNumber
                    ...
                    controls={false}
                    min={0}
                    precision={ECR_DECIMALS}
                    onChange={(value) => setAmountSat(value ? Math.round(value * SAT_PER_ECR) : 0)}
                />
            </Form.Item>
